...
DISK_IMG=/home/ftvee/research/qemu/host2.qcow2
...
-object memory-backend-file,id=far0,mem-path=/dev/shm/far-mem1,size=8G,share=on \
-numa node,nodeid=0,memdev=dram0,cpus=0-7 \
-numa node,nodeid=1,memdev=far0 \
-drive file="$DISK_IMG",if=virtio \
-netdev tap,id=net0,ifname=$TAP,script=no,downscript=no \
-device virtio-net-pci,netdev=net0,mac=52:54:00:01:00:02 \
-serial stdio